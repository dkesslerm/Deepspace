...
class CardDealer 
    ...
    def createWeapons() 
       ...
       @weapons.add(Weapon.new("Misil Bill Bala",WeaponType::MISSILE,1))
       @weapons.add(Weapon.new("Cañón Lanza Bill",WeaponType::PLASMA,10))
    end
    ...
    def createEnemies() 
        ...
        @enemies.add(EnemyStarShip.new("Bullejos",750,750,badLoot,hardSpecificDamage0))              
    end
end # class
